...
export function PlatformIcon({ platform, size = 16 }: PlatformIconProps) {
  const icons: Record<Platform, string> = {
    douyin: `<svg viewBox="0 0 24 24" width="${size}" height="${size}">
      <path fill="#000000" d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v.45a8.26 8.26 0 0 0 6.48 8.22v.45h3.45v-.45a4.83 4.83 0 0 1-3.71-2.02zM9.96 12.87a4.83 4.83 0 0 1-3.77-4.25V8.2H2.74v.45a8.26 8.26 0 0 0 6.48 8.22v.45h3.45v-.45a4.83 4.83 0 0 1-3.71-2v-.02z"/>
